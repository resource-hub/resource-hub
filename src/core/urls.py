...
urlpatterns = [
    ...
    url(r'^admin/organizations/profile/(?P<organization_id>\w{0,50})/$',
        views.organizations_profile,
        name='organizations_profile'),
    url(r'^admin/organizations/profile/edit/(?P<organization_id>\w{0,50})/(?P<scope>\w{0,50})/$',
        views.organizations_profile_edit,
        name='organizations_profile_edit'),
    url(r'^admin/organizations/members/(?P<organization_id>\w{0,50})/$',
        views.organizations_members,
        name='organizations_members'),
    url(r'^admin/organizations/members/add/(?P<organization_id>\w{0,50})/$',
